...
namespace CTRLPlusN\Modules\LinkModule\Widget\LinkBlock\TwigExtension;
...
class LinkBlockExtension extends \Twig_Extension {
    ...
    public function getBlockHelper() {
        return $this->container->get('link.widget.link_block.helper')->render($this->container->get('module.link_module')->getLinks());
    }
